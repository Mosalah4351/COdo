export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju COdo-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} COdo-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'COdo'.",
