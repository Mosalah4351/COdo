export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de COdo",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de COdo. ¿Quieres instalarla y reiniciar?",
