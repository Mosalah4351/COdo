...
import type { UpdaterState } from "@codo-ai/app/updater"
...
const deepLinkEvent = "COdo:deep-link"
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("COdo.global.dat").getItem("language")
