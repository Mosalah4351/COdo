...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-COdo", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeCOdo(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-COdo", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installCOdo(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-COdo", unavailable)
  ipcMain.handle("wsl-servers-install-COdo", unavailable)
