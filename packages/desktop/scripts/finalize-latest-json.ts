...
const releaseId = process.env.CODO_RELEASE
if (!releaseId) throw new Error("CODO_RELEASE is required")

const version = process.env.CODO_VERSION
if (!version) throw new Error("CODO_VERSION is required")
...
const macxTarGz = "COdo-desktop-mac-x64.app.tar.gz"
const macaTarGz = "COdo-desktop-mac-arm64.app.tar.gz"
