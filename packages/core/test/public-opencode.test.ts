...
import { AbsolutePath, Location, Model, COdo, Session, Tool } from "@codo-ai/core/public"
import { tmpdir } from "./fixture/tmpdir"
import { testEffect } from "./lib/effect"

const it = testEffect(COdo.layer)

describe("public native COdo API", () => {
  it.effect("exposes only the intentional Session capabilities", () =>
    Effect.gen(function* () {
      const opencode = yield* COdo.Service
