...
import { ProviderPlugins } from "@codo-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@codo-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://codo-ai.vercel.app/", "X-Title": "opencode" })
