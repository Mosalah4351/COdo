...
import type { EffectDrizzleSqlite } from "@codo-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@codo/ProjectDirectories") {}
