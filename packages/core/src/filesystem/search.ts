...
export class Service extends Context.Service<Service, Interface>()("@codo/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.CODO_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
