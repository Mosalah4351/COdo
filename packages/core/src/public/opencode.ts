...
/** Intentional public native API for Effect applications embedding COdo. */
export class Service extends Context.Service<Service, Interface>()("@codo/public/COdo") {}
...
>()("@codo/public/COdo/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("COdo.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("COdo.sessions.switchModel")(function* (input) {
...
// TODO: Add COdo.create(...) as the Promise facade over the same native API semantics.
