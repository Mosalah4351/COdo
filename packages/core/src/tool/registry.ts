...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@codo-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@codo/v2/ToolRegistry") {}
