...
With COdo you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, COdo uses our own `COdo` theme.
...
COdo comes with several built-in themes.
...
- Want COdo to match their terminal's appearance
...
COdo supports a flexible JSON-based theme system that allows users to create and customize themes easily.
