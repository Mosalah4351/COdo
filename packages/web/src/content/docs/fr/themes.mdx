...
Avec COdo, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, COdo utilise notre propre thème `COdo`.
...
COdo est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que COdo corresponde à l'apparence de leur terminal
...
COdo prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
{
  "$schema": "https://codo-ai.vercel.app/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
