...
Com o COdo, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o COdo usa nosso próprio tema `COdo`.
...
O COdo vem com vários temas embutidos.
...
- Querem que o COdo corresponda à aparência do seu terminal
...
O COdo suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
