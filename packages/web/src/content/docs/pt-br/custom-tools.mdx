...
description: Crie ferramentas que o LLM pode chamar no COdo.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do COdo, como `read`, `write` e `bash`.
