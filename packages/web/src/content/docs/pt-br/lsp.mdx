...
description: O COdo integra-se aos seus servidores LSP.
---

O COdo pode se integrar a servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para o agente.

---

## Integrados

O COdo vem com vários servidores LSP integrados para linguagens populares:
...
Quando o LSP está habilitado e o COdo abre um arquivo, ele:
...
Você pode habilitar e personalizar os servidores LSP através da seção `lsp` na sua configuração do COdo.
