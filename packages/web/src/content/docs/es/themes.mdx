...
Con COdo puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, COdo usa nuestro propio tema `COdo`.
...
COdo viene con varios temas integrados.
...
- Quiere que COdo coincida con la apariencia de su terminal
...
COdo admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
