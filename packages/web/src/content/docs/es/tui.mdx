---
title: TUI
description: Usando la interfaz de usuario del terminal COdo.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

COdo proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar COdo se inicia TUI para el directorio actual.
...
Cuando utilice COdo TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a COdo. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `COdo.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera COdo después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `COdo.default`.
