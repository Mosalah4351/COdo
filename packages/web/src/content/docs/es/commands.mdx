...
Puede agregar comandos personalizados a través de la configuración COdo o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su COdo [config](/docs/config):
...
COdo incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
