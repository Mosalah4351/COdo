---
title: Soporte ACP
description: Utilice COdo en cualquier editor compatible con ACP.
---

COdo admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar COdo a través de ACP, configure su editor para ejecutar el comando `COdo acp`.

El comando inicia COdo como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'COdo' en el selector de agentes de AI Chat.
...
Para usar COdo como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar COdo como agente ACP para el chat.
...
COdo funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración COdo
