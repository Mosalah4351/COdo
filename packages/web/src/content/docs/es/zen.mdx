---
title: Zen
description: Lista seleccionada de modelos proporcionada por COdo.
---
...
COdo Zen es una lista de modelos probados y verificados proporcionada por el equipo de COdo.

Zen funciona como cualquier otro proveedor en COdo. Inicias sesión en COdo Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con COdo.
:::
...
COdo Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

COdo Zen funciona como cualquier otro proveedor en COdo.

1. Inicias sesión en **<a href={console}>COdo Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas COdo Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de COdo
...
- DeepSeek V4 Flash Free está disponible en COdo por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en COdo por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en COdo por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en COdo por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en COdo por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con COdo.
