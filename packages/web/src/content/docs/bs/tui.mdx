---
title: TUI
description: Korištenje korisničkog interfejsa COdo terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

COdo pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje COdo pokreće TUI za trenutni direktorij.
...
Kada koristite COdo TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u COdo. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz COdo. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `COdo.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo COdo čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `COdo.default`.
