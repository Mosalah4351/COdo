...
U COdo mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, COdo koristi nasu `COdo` temu.
...
COdo dolazi sa vise ugradenih tema.
...
- Zele da COdo odgovara izgledu njihovog terminala
...
COdo podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
