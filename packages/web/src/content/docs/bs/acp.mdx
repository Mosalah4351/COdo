---
title: ACP podrška
description: Koristite COdo u bilo kojem uređivaču kompatibilnom sa ACP.
---

COdo podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili COdo putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `COdo acp`.

Naredba pokreće COdo kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "COdo" agenta u AI Chat agent selektoru.
...
Da koristite COdo kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi COdo kao ACP chat agenta.
...
COdo radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj COdo konfiguraciji
