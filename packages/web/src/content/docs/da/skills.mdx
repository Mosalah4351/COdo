...
Agentferdigheter lar COdo oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
COdo søker etter disse stedene:
...
For prosjektlokale stier går COdo opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
COdo viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `COdo.json`:
...
**For innebygde agenter** (i `COdo.json`):
