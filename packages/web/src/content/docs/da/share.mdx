---
title: Deling
description: Del dine COdo-samtaler.
---

COdos delingsfunksjon lar deg lage offentlige lenker til dine COdo-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
COdo støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger COdo manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `COdo.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av COdo i organisasjonen din.
