---
title: LSP-servere
description: COdo integreres med dine LSP-servere.
---

COdo kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

COdo leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og COdo åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din COdo-konfiguration.
