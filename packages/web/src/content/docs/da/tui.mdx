---
title: TUI
description: Brug af COdo-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

COdo giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre COdo starter TUI for den nuværende mappe.
...
Når du bruger COdo TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til COdo. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `COdo.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe COdo venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `COdo.default`.
