---
title: Server LSP
description: COdo si integra con i tuoi server LSP.
---

COdo può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

COdo include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e COdo apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di COdo.
