...
description: Verwenden Sie COdo in jedem ACP-kompatiblen Editor.
---

COdo unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um COdo über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `COdo acp`.

Der Befehl startet COdo als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „COdo“ in der AI Chat Agent Selector.
...
Um COdo als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass COdo als ACP-Agent für den Chat verwendet wird.
...
COdo funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer COdo-Konfiguration konfiguriert sind
