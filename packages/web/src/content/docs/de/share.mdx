---
title: Teilen
description: Teile COdo-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu COdo-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht COdo Folgendes:
...
COdo hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt COdo den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`COdo.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du COdo in deiner Organisation einsetzt.
