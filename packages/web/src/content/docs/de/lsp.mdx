---
title: LSP Server
description: COdo lässt sich in Ihren LSP-Server integrieren.
---

COdo kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

COdo verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und COdo eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer COdo-Konfiguration aktivieren und anpassen.
