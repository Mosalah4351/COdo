---
title: LSP Servers
description: COdo integrates with your LSP servers.
---

COdo can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

COdo comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and COdo opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your COdo config.
