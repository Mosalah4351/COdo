---
title: LSP-servere
description: COdo integreres med LSP-serverne dine.
---

COdo kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

COdo kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og COdo åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i COdo-konfigurasjonen.
