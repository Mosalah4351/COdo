...
Agentferdigheter lar COdo oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går COdo opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
COdo viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `COdo.json`:
