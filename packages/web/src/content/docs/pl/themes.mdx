...
Dzięki COdo możesz wybrać jeden z kilku wbudowanych motywów, użyć motywu, który dostosowuje się do motywu terminala lub zdefiniować własny, niestandardowy motyw.

Domyślnie COdo używa naszego własnego motywu `COdo`.
...
COdo ma kilka wbudowanych motywów.
...
- Chcą, aby COdo pasował do wyglądu ich terminala
...
COdo obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
