---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala COdo.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

COdo zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie COdo uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI COdo, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do COdo. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `COdo.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo COdo czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `COdo.default`.
