---
title: Serwery LSP
description: COdo integruje się z serwerami LSP.
---

COdo może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

COdo posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i COdo otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji COdo.
