---
title: خوادم LSP
description: يتكامل COdo مع خوادم LSP لديك.
---

يمكن أن يتكامل COdo مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي COdo مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح COdo لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات COdo.
