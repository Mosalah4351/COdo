---
title: 규칙
description: COdo에 대한 사용자 정의 지침 설정.
---
...
`instructions`의 `COdo.json` 필드를 사용하는 것이 좋습니다.
...
- 특정 작업에 필요한 경우에만 COdo 로드 파일 유지

:::tip
공유 표준을 가진 monorepos 또는 프로젝트를 위해, glob 본을 가진 `COdo.json`를 사용하여 (`packages/*/AGENTS.md` 같이)는 수동 지시 보다는 더 유지가능합니다.
:::
