...
description: COdo dile özgü biçimlendiriciler kullanır.
---

COdo, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

COdo, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, COdo bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

COdo bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri COdo yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
