---
title: Paylasim
description: COdo konusmalarini genel baglantilarla paylasin.
---

COdo'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda COdo:
...
COdo, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak COdo manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `COdo.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda COdo kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
