---
title: Zen
description: COdo tarafından sağlanan seçilmiş modeller listesi.
---
...
COdo Zen, COdo ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, COdo'daki diğer sağlayıcılar gibi çalışır. COdo Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve COdo kullanmak için buna ihtiyacınız yoktur.
...
:::tip
COdo ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
COdo Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

COdo Zen, COdo'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>COdo Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, COdo Zen'i seçin ve API anahtarınızı yapıştırın.
...
COdo yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için COdo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için COdo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için COdo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için COdo'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için COdo'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
COdo Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca COdo ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
