---
title: SDK
description: COdo sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

COdo JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
COdo'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `COdo.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir COdo örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
