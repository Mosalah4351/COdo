...
COdo ile birden fazla yerleşik tema arasından seçim yapabilir, terminal temanıza uyum sağlayan bir tema kullanabilir veya kendi özel temanızı tanımlayabilirsiniz.

Varsayılan olarak COdo kendi `COdo` temasını kullanır.
...
COdo birden fazla yerleşik temayla gelir.
...
- COdo'un terminal görünümüyle birebir uyumlu olmasını isteyenler
...
COdo, kullanıcıların kolayca tema oluşturup özelleştirebilmesi için esnek bir JSON tabanlı tema sistemi sunar.
