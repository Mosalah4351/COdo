...
import { and, Database, eq, isNull, lt, or, sql } from "@codo-ai/console-core/drizzle/index.js"
import { KeyTable } from "@codo-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@codo-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@codo-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@codo-ai/console-core/util/date.js"
import { Identifier } from "@codo-ai/console-core/identifier.js"
import { Billing } from "@codo-ai/console-core/billing.js"
import { Actor } from "@codo-ai/console-core/actor.js"
import { WorkspaceTable } from "@codo-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@codo-ai/console-core/model.js"
import { Subscription } from "@codo-ai/console-core/subscription.js"
import { BlackData } from "@codo-ai/console-core/black.js"
import { UserTable } from "@codo-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@codo-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@codo-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@codo-ai/console-core/lite.js"
import { Resource } from "@codo-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-COdo-session") ?? ""
    const requestId = input.request.headers.get("x-COdo-request") ?? ""
    const ocClient = input.request.headers.get("x-COdo-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-COdo-request")
          headers.delete("x-COdo-session")
          headers.delete("x-COdo-project")
          headers.delete("x-COdo-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://COdo.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://COdo.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://COdo.ai/workspace/${authInfo.workspaceID}/members`
