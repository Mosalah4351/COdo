...
import compareVideo from "../../asset/lander/COdo-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/COdo-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="COdo:auth" content={loggedin() ? "true" : "false"} />
