...
import desktopAppIcon from "../../asset/lander/COdo-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://COdo.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>COdo.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g COdo-ai")}>
                <code>
                  npm i -g <strong>COdo-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g COdo-ai")}>
                <code>
                  bun add -g <strong>COdo-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/COdo")}>
                <code>
                  brew install <strong>anomalyco/tap/COdo</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S COdo")}>
                <code>
                  paru -S <strong>COdo</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask COdo-desktop")}>
                <code>
                  brew install --cask <strong>COdo-desktop</strong>
                </code>
                <CopyStatus />
              </button>
