...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | COdo",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "COdo logo lys",
  "notFound.logoDarkAlt": "COdo logo mørk",
  ...
  "app.meta.description": "COdo - Den åpne kildekode kodingsagenten.",

  "home.title": "COdo | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "COdo | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av COdo",
  ...
  "temp.screenshot.caption": "COdo TUI med tokyonight-tema",
  "temp.screenshot.alt": "COdo TUI med tokyonight-tema",
  "temp.logoLightAlt": "COdo logo lys",
  "temp.logoDarkAlt": "COdo logo mørk",
  ...
  "home.what.title": "Hva er COdo?",
  "home.what.body": "COdo er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes COdo av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "COdo lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er COdo?",
  "home.faq.a1":
    "COdo er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg COdo?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke COdo?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. COdo kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men COdo fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med COdo?",
  "home.faq.a4.p1":
    "Ja, COdo støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke COdo i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! COdo er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster COdo?",
  "home.faq.a6":
    "COdo er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er COdo åpen kildekode?",
  "home.faq.a8.p1": "Ja, COdo er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som COdo har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "COdo Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som COdo har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er COdo Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak COdo.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan COdo forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger COdo til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med COdo, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare COdo-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med COdo, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.title": "COdo Go | Rimelige kodemodeller for alle",
  "go.banner.text": "MiniMax M3 får 3x bruksgrense i en begrenset periode",
  "go.meta.description":
    "Go starter på $5 for den første måneden, deretter $10/måned, med sjenerøse 5-timers forespørselsgrenser for GLM-5.1, GLM-5, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro og DeepSeek V4 Flash.",
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe COdo-opplevelsen til så mange som mulig. COdo Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med COdo eller hvilken som helst agent.",
  ...
  "go.faq.a3":
    "Nei. Zen er betaling etter bruk, mens Go starter på $5 for den første måneden, deretter $10/måned, med sjenerøse grenser og pålitelig tilgang til åpen kildekode-modellene GLM-5.1, GLM-5, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro og DeepSeek V4 Flash.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på COdo Go - {{link}}",

  "black.meta.title": "COdo Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med COdo Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "COdo Black | Priser",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for COdo Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med COdo når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg COdo",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start COdo og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til COdo-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en COdo Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på COdo Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for COdo Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på COdo Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.message": "Du abonnerer på COdo Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "COdo Go" som leverandør i COdo-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på COdo Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på COdo Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "COdo Go starter på {{price}}, deretter $10/måned, og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "COdo | Last ned",
  "download.meta.description": "Last ned COdo for macOS, Windows og Linux",
  "download.hero.title": "Last ned COdo",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble COdo til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer COdo med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "COdo er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om COdo fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i COdo.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "COdo | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt COdo for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "COdo opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er COdo Enterprise?",
  "enterprise.faq.a1":
    "COdo Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med COdo Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. COdo lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med COdo Enterprise?",
  "enterprise.faq.a4":
    "Ja. COdo lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "COdo | Merkevare",
  "brand.meta.description": "COdo retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med COdo-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "COdo | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for COdo",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for COdo",
