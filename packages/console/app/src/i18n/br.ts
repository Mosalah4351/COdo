...
export const dict = {
  ...
  "notFound.title": "Não encontrado | COdo",
  "notFound.heading": "404 - Página não encontrada",
  "notFound.home": "Início",
  "notFound.docs": "Documentação",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo COdo claro",
  "notFound.logoDarkAlt": "logo COdo escuro",
  ...
  "app.meta.description": "COdo - O agente de codificação de código aberto.",

  "home.title": "COdo | O agente de codificação de código aberto com IA",

  "temp.title": "COdo | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela COdo",
  ...
  "temp.screenshot.caption": "COdo TUI com o tema tokyonight",
  "temp.screenshot.alt": "COdo TUI com tema tokyonight",
  "temp.logoLightAlt": "logo COdo claro",
  "temp.logoDarkAlt": "logo COdo escuro",
  ...
  "home.what.title": "O que é COdo?",
  "home.what.body":
    "COdo é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, COdo é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "COdo não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é COdo?",
  "home.faq.a1":
    "COdo é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o COdo?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o COdo?",
  "home.faq.a3.p1":
    "Não necessariamente, COdo vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, COdo também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o COdo?",
  "home.faq.a4.p1":
    "Sim, COdo suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o COdo apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! COdo agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o COdo?",
  "home.faq.a6":
    "COdo é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "COdo é código aberto?",
  "home.faq.a8.p1": "Sim, COdo é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a COdo testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "zen.title": "COdo Zen | Um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.title": "Modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a COdo testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é COdo Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do COdo.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a COdo pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a COdo adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o COdo, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do COdo.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o COdo, você pode usá-lo com qualquer agente.",
  ...
  "go.title": "COdo Go | Modelos de codificação de baixo custo para todos",
  "go.banner.text": "MiniMax M3 tem limite de uso 3x maior por tempo limitado",
  "go.meta.description":
    "O Go começa em $5 no primeiro mês, depois $10/mês, com limites generosos de solicitação de 5 horas para GLM-5.1, GLM-5, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro e DeepSeek V4 Flash.",
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do COdo para o maior número de pessoas possível. COdo Go é uma assinatura de baixo custo: $5 no primeiro mês, depois $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.problem.item4":
    "Inclui GLM-5.1, GLM-5, Kimi K2.7 Code, Kimi K2.6, MiMo-V2.5-Pro, MiMo-V2.5, Qwen3.7 Max, Qwen3.7 Plus, Qwen3.6 Plus, MiniMax M2.7, MiniMax M3, DeepSeek V4 Pro e DeepSeek V4 Flash",
  "go.how.title": "Como o Go funciona",
  "go.how.body":
    "O Go começa em $5 no primeiro mês, depois $10/mês. Você pode usá-lo com o COdo ou qualquer agente.",
  ...
  "zen.api.error.trialEnded":
    "A promoção gratuita do {{model}} terminou. Você pode continuar usando o modelo assinando o COdo Go - {{link}}",

  "black.meta.title": "COdo Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura COdo Black.",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do COdo Black",
  "black.subscribe.success.subscriptionPlan": "Plano de assinatura",
  "black.subscribe.success.planName": "COdo Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com COdo sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione COdo",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o COdo e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços COdo.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do COdo Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o COdo Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano COdo Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano COdo Black de ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o COdo Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "COdo Go" como provedor na sua configuração do COdo para usar os modelos Go.',
  "workspace.lite.black.message":
    "Você está atualmente inscrito no COdo Black ou na lista de espera. Por favor, cancele a assinatura primeiro se desejar mudar para o Go.",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o COdo Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.description":
    "O COdo Go começa em {{price}}, depois $10/mês, e oferece acesso confiável a modelos de codificação abertos populares com limites de uso generosos.",
  ...
  "download.title": "COdo | Baixar",
  "download.meta.description": "Baixe o COdo para macOS, Windows e Linux",
  "download.hero.title": "Baixar COdo",
  "download.hero.subtitle": "Disponível em Beta para macOS, Windows e Linux",
  "download.hero.button": "Baixar para {{os}}",
  "download.section.terminal": "COdo Terminal",
  "download.section.desktop": "COdo Desktop (Beta)",
  "download.section.extensions": "Extensões COdo",
  "download.section.integrations": "Integrações COdo",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o COdo a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o COdo funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O COdo é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o COdo funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no COdo.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "COdo | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a COdo para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O COdo opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é COdo Enterprise?",
  "enterprise.faq.a1":
    "COdo Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o COdo Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O COdo por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o COdo Enterprise?",
  "enterprise.faq.a4":
    "Sim. O COdo não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "COdo | Marca",
  "brand.meta.description": "Diretrizes da marca COdo",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca COdo.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "COdo | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do COdo",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no COdo",
