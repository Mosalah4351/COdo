...
const CUSTOM_PROVIDER_OPTION_VALUE = "__COdo_custom_provider__"
    ...
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          ...
          "COdo-go": "Low cost subscription for everyone",
        }[provider.id],
    ...
    <DialogPrompt
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in COdo.json to use it.`,
          })
          dialog.clear()
          return
        }
