...
export const TypeId: TypeId = "~@codo-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@codo-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@codo-ai/effect-sqlite-node/NodeSqliteClient")
