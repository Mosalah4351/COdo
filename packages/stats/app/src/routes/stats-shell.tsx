import COdoWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/COdo",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star COdo on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "COdo:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://COdo.ai/">
            <strong>Try COdo</strong>
          </a>
          <button
...
function COdoMark() {
  return (
    <svg data-slot="COdo-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://COdo.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://COdo.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@COdo.ai", label: "Contact us" },
    { href: "https://COdo.ai/discord", label: "Community" },
    { href: "https://x.com/COdo", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://COdo.ai" aria-label="COdo home">
          <COdoMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={COdoWordmarkDark} alt="COdo" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">COdo Newsletter</h2>
            <p>
