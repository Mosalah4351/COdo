...
declare const COdo_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof COdo_CLI_NAME === "string" ? COdo_CLI_NAME : "COdo", {
  description: "COdo 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
