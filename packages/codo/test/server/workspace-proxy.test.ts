...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips codo-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-codo-directory"]).toBeUndefined()
      expect(forwarded["x-codo-workspace"]).toBeUndefined()
