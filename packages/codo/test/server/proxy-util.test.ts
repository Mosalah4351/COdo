...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips codo-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-codo-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-codo-directory")).toBeNull()
      expect(result.get("x-codo-workspace")).toBeNull()
