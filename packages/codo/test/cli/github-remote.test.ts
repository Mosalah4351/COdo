...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codo.git")).toEqual({ owner: "sst", repo: "codo" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codo")).toEqual({ owner: "sst", repo: "codo" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codo.git")).toEqual({ owner: "sst", repo: "codo" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codo")).toEqual({ owner: "sst", repo: "codo" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codo.git")).toEqual({ owner: "sst", repo: "codo" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codo")).toEqual({ owner: "sst", repo: "codo" })
})
