...
export interface Interface {
  ...
  /**
   * Resolved truncation limits: values from `tool_output` in COdo config, or MAX_LINES / MAX_BYTES if unset.
   */
  readonly limits: () => Effect.Effect<{ maxLines: number; maxBytes: number }>
}

export class Service extends Context.Service<Service, Interface>()("@codo/Truncate") {}
