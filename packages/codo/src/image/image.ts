...
export class Service extends Context.Service<Service, Interface>()("@codo/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __COdo_PHOTON_WASM_PATH?: string }).__COdo_PHOTON_WASM_PATH =
