...
import { ProjectDirectoryTable, ProjectTable } from "@codo-ai/core/project/sql"
import { ProjectDirectories } from "@codo-ai/core/project/directories"
...
import { which } from "@codo-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@codo-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codo/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CODO_FAKE_VCS)
