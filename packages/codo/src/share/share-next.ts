...
import type * as SDK from "@codo-ai/sdk/v2"
...
import { SessionShareTable } from "@codo-ai/core/share/sql"
import { ProviderV2 } from "@codo-ai/core/provider"
import { ModelV2 } from "@codo-ai/core/model"
import { EventV2 } from "@codo-ai/core/event"

const disabled = process.env["CODO_DISABLE_SHARE"] === "true" || process.env["CODO_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codo/ShareNext") {}
