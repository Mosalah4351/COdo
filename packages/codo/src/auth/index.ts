...
export const OAUTH_DUMMY_KEY = "COdo-oauth-dummy-key"
...
export class Service extends Context.Service<Service, Interface>()("@codo/Auth") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const all = Effect.fn("Auth.all")(function* () {
      if (process.env.CODO_AUTH_CONTENT) {
        try {
          return JSON.parse(process.env.CODO_AUTH_CONTENT)
        } catch (err) {}
      }
