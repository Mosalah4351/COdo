import type { Hooks, PluginInput } from "@codo-ai/plugin"
import type { Model } from "@codo-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>COdo - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to COdo."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. COdo will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
