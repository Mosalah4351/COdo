...
<html>
  <head>
    <title>COdo - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>COdo - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "COdo"
      output.headers["User-Agent"] = `COdo/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
