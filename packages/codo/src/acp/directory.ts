...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@codo/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@codo/ACPDirectory") {}
