 ...
 *   "@codo/ServerAuthConfig",
 *   {
 *     password: Config.string("CODO_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODO_SERVER_USERNAME").pipe(Config.withDefault("COdo")),
 *   },
 * ) {}
 *
