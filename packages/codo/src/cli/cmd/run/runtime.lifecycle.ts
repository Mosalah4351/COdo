...
import { openEditor } from "@codo-ai/tui/editor"
import { registerCOdoKeymap } from "@codo-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerCOdoKeymap(keymap, renderer, input.tuiConfig)
