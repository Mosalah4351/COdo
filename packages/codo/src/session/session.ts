...
import { PartTable, SessionTable } from "@codo-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@codo-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".codo", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@codo/Session") {}
