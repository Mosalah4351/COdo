import type { JsonSchema, LLMRequest, ProviderMetadata } from "@codo-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@codo-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @codo-ai/llm request objects from COdo's session/AI SDK-shaped data.
  return LLM.request({
