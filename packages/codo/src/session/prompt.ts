...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@codo-ai/core/session/prompt"
...
export class Service extends Context.Service<Service, Interface>()("@codo/SessionPrompt") {}
