...
import { AbsolutePath, type DeepMutable } from "@codo-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codo/Agent") {}
