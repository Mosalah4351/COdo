...
import type { AssistantMessage as COdoAssistantMessage, Message } from "@codo-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<COdoAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<COdoAssistantMessage, "role"> &
  Partial<Pick<COdoAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@codo/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@codo/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@codo/ACPUsage") {}
