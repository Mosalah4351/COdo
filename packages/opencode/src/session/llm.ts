...
import { llmClient } from "@codo-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@codo-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@codo-ai/llm/route"
import type { LLMClientService } from "@codo-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@codo/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via COdo's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @codo-ai/llm. It
