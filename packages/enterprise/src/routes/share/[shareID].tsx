import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@COdo-ai/sdk/v2"
import { SessionTurn } from "@COdo-ai/ui/session-turn"
import { SessionReview } from "@COdo-ai/ui/session-review"
import { DataProvider } from "@COdo-ai/ui/context"
import { FileComponentProvider } from "@COdo-ai/ui/context/file"
import { WorkerPoolProvider } from "@COdo-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@COdo-ai/ui/logo"
import { IconButton } from "@COdo-ai/ui/icon-button"
import { ProviderIcon } from "@COdo-ai/ui/provider-icon"
import { iife } from "@COdo-ai/core/util/iife"
import { Binary } from "@COdo-ai/core/util/binary"
import { NamedError } from "@COdo-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@COdo-ai/ui/tabs"
import { MessageNav } from "@COdo-ai/ui/message-nav"
import { FileSSR } from "@COdo-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@COdo-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/COdo-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | COdo</Title>
              </Show>
              <Meta name="description" content="COdo - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/COdo"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
