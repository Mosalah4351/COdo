...
const directory = "C:/COdo/ContextResizeRegression"
...
const model = { providerID: "codo", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["codo"],
    default: { providerID: "codo", modelID: "claude-opus-4-6" },
  }
}
