...
import { ResizeHandle } from "@codo-ai/ui/resize-handle"
...
import { Session, type Message } from "@codo-ai/sdk/v2/client"
...
import { toaster } from "@codo-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@codo-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://COdo.ai/desktop-feedback")}
      renderPanel={() =>
