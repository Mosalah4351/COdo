...
beforeAll(async () => {
  ...
  mock.module("@codo-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codo-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codo-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codo-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
