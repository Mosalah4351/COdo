import { AppIcon } from "@codo-ai/ui/app-icon"
...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("COdo-titlebar-center"))
    setRightMount(document.getElementById("COdo-titlebar-right"))
  })
