...
import { Dialog, DialogFooter } from "@codo-ai/ui/v2/dialog-v2"
import { ButtonV2 } from "@codo-ai/ui/v2/button-v2"
import { TextInputV2 } from "@codo-ai/ui/v2/text-input-v2"
...
import { DividerV2 } from "@codo-ai/ui/v2/divider-v2"
...
export function DialogSelectDirectoryV2(props: DialogSelectDirectoryV2Props) {
  ...
  return (
    <Dialog size="large" class="directory-picker-v2" title={props.title ?? language.t("command.project.open")}>
      <DividerV2 />
      <div class="directory-picker-v2-body pt-4!">
