import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@codo-ai/sdk/v2/client"
...
import { List, type ListRef } from "@codo-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "COdo"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.COdoZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.COdoZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.COdoZen.visit.prefix")}
                <Link href="https://COdo.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.COdoZen.visit.link")}
                </Link>
                {language.t("provider.connect.COdoZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
