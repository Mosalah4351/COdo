...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "COdo", key: "dialog.provider.COdo.note" },
  { match: (id: string) => id === "COdo-go", key: "dialog.provider.COdoGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "COdo" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "COdo" || item.id === "COdo-go"}>
