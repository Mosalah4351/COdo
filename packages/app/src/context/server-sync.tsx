import type { Config, COdoClient, Path, Project, ProviderAuthResponse, Todo } from "@codo-ai/sdk/v2/client"
...
import { createSimpleContext, NormalizedProviderListResponse } from "@codo-ai/ui/context"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: COdoClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: COdoClient) =>
  queryOptions({
...
export function createServerSyncContextInner(_serverSDK?: ServerSDK) {
  ...
  const sdkCache = new Map<string, COdoClient>()
