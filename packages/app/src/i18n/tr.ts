...
export const dict = {
  ...
  "dialog.provider.COdo.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.COdo.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.COdoGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "COdo tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve COdo'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.COdoZen.line1":
    "COdo Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.COdoZen.visit.prefix": "",
  "provider.connect.COdoZen.visit.link": "COdo.ai/zen",
  "provider.connect.COdoZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve COdo'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak COdo'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler COdo.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi COdo sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "COdo'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı COdo ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (COdo.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: COdo henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "COdo ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "COdo Masaüstü",
  ...
  "settings.desktop.wsl.description": "COdo sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "COdo'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "COdo'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "COdo'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "COdo'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "COdo başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "COdo'un en son sürümünü kullanıyorsunuz.",
