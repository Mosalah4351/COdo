export const dict = {
  ...
  "dialog.provider.COdo.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.COdo.tagline": "Reliable optimized models",
  "dialog.provider.COdoGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by COdo",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in COdo.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.COdoZen.line1":
    "COdo Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.COdoZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.COdoZen.visit.prefix": "Visit ",
  "provider.connect.COdoZen.visit.link": "COdo.ai/zen",
  "provider.connect.COdoZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in COdo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in COdo.",
  ...
  "dialog.plugins.empty": "Plugins configured in COdo.json",
  ...
  "dialog.server.description": "Switch which COdo server this app connects to.",
  ...
  "wsl.onboarding.checkingCOdo": "Checking COdo...",
  "wsl.onboarding.checkingCOdoIn": "Checking COdo in {{distro}}...",
  "wsl.onboarding.updatingCOdo": "Updating COdo...",
  "wsl.onboarding.updatingCOdoIn": "Updating COdo in {{distro}}...",
  "wsl.onboarding.updateCOdoIn": "Update COdo in {{distro}}.",
  "wsl.onboarding.updateCOdo": "Update COdo",
  "wsl.onboarding.COdoReadyIn": "COdo is ready in {{distro}}.",
  "wsl.onboarding.COdoReady": "COdo is ready.",
  "wsl.onboarding.installCOdoIn": "Install COdo in {{distro}}.",
  "wsl.onboarding.installCOdo": "Install COdo",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen COdo.",
  ...
  "toast.update.description": "A new version of COdo ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the COdo team",
  ...
  "error.chain.checkConfig": "Check your config (COdo.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, COdo does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "COdo includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the COdo server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for COdo",
  ...
  "settings.general.row.appearance.description": "Customise how COdo looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether COdo follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how COdo is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when COdo launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of COdo.",
