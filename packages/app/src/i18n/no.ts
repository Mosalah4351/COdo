...
export const dict = {
  ...
  "dialog.provider.COdo.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.COdo.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.COdoGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av COdo",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i COdo.",
  ...
  "provider.connect.COdoZen.line1":
    "COdo Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.COdoZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.COdoZen.visit.prefix": "Besøk ",
  "provider.connect.COdoZen.visit.link": "COdo.ai/zen",
  "provider.connect.COdoZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i COdo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i COdo.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i COdo.json",
  ...
  "dialog.server.description": "Bytt hvilken COdo-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av COdo ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til COdo-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (COdo.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at COdo ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "COdo inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør COdo-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for COdo",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan COdo ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om COdo skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan COdo er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når COdo starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av COdo.",
