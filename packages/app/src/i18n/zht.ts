...
export const dict = {
  ...
  "dialog.provider.COdo.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.COdo.tagline": "可靠的優化模型",
  "dialog.provider.COdoGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "COdo 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 COdo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.COdoZen.line1": "COdo Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.COdoZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.COdoZen.visit.prefix": "造訪 ",
  "provider.connect.COdoZen.visit.link": "COdo.ai/zen",
  "provider.connect.COdoZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 COdo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 COdo 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 COdo.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 COdo 伺服器。",
  ...
  "toast.update.description": "COdo 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 COdo 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (COdo.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: COdo 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "COdo 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 COdo 伺服器。",
  ...
  "settings.general.row.language.description": "變更 COdo 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 COdo 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 COdo 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 COdo 的主題。",
  ...
  "settings.updates.row.startup.description": "在 COdo 啟動時自動檢查更新",
