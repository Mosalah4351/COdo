export const dict = {
  ...
  "dialog.provider.COdo.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.COdo.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.COdoGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez COdo",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w COdo.",
  ...
  "provider.connect.COdoZen.line1":
    "COdo Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.COdoZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.COdoZen.visit.prefix": "Odwiedź ",
  "provider.connect.COdoZen.visit.link": "COdo.ai/zen",
  "provider.connect.COdoZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w COdo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w COdo.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w COdo.json",
  ...
  "dialog.server.description": "Przełącz serwer COdo, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja COdo ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu COdo",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (COdo.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "COdo zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla COdo",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd COdo na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy COdo ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw COdo.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania COdo",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji COdo.",
